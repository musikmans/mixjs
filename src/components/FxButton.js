                ...
                <img
                    ...
                    onMouseDown={() => {
                        switch (this.state.componentId) {
                            case "fx-delay-1":
                                if (store.getState().reverb_left.reverb_left === true || store.getState().lpf_left.lpf_left !== 0 ||
                                    store.getState().hpf_left.hpf_left !== 0 || store.getState().pan_left.pan_left !== 0) {
                                    return;
                                }
                                this.setState({
                                ...
                                break;
                            case "fx-reverb-1":
                                if (store.getState().delay_left.delay_left === true || store.getState().lpf_left.lpf_left !== 0 ||
                                    store.getState().hpf_left.hpf_left !== 0 || store.getState().pan_left.pan_left !== 0) {
                                    return;
                                }
                                this.setState({
                                ...
                                break;
                            case "fx-delay-2":
                                if (store.getState().reverb_right.reverb_right === true || store.getState().lpf_right.lpf_right !== 0 ||
                                    store.getState().hpf_right.hpf_right !== 0 || store.getState().pan_right.pan_right !== 0) {
                                    return;
                                }
                                this.setState({
                                    img: 'Assets/FxButton_pressed.svg',
                                ...
                                break;
                            default:
                                if (store.getState().delay_right.delay_right === true || store.getState().lpf_right.lpf_right !== 0 ||
                                    store.getState().hpf_right.hpf_right !== 0 || store.getState().pan_right.pan_right !== 0) {
                                    return;
                                }
                                this.setState({
